...
class Ui_CreateNewWallet(object):
    def setupUi(self, CreateNewWallet):
        ...
        self.newWallet_back.setGeometry(QtCore.QRect(20, 14, 113, 41))
...
"color:rgb(255, 255, 255)")
        ...
        self.igalmelapela = QtWidgets.QPushButton(CreateNewWallet)
        self.igalmelapela.setEnabled(True)
        self.igalmelapela.setGeometry(QtCore.QRect(540, 10, 51, 60))
