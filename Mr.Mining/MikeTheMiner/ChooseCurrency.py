...
class Ui_ChooseCurrency(object):
    def setupUi(self, ChooseCurrency):
        ...
        self.ethereum.setGeometry(QtCore.QRect(83, 150, 90, 90))
...
"")
        ...
        self.ethereum_classic.setGeometry(QtCore.QRect(264, 150, 90, 90))
        ...
        self.zcash.setGeometry(QtCore.QRect(443, 150, 90, 90))
        ...
        self.pascal.setGeometry(QtCore.QRect(83, 310, 90, 90))
        ...
        self.sia.setGeometry(QtCore.QRect(264, 310, 90, 90))
        ...
        self.monero.setGeometry(QtCore.QRect(443, 310, 90, 90))
...
"color:rgb(255, 255, 255)")
        ...
        self.monero_zcash.setGeometry(QtCore.QRect(443, 470, 90, 90))
        ...
        self.monero_pasc_monero.setGeometry(QtCore.QRect(264, 470, 90, 90))
        ...
        self.monero_eth_sia.setGeometry(QtCore.QRect(83, 470, 90, 90))
        ...
        self.etc_coin.setGeometry(QtCore.QRect(267, 280, 90, 20))
        ...
        self.zec_coin.setGeometry(QtCore.QRect(443, 280, 90, 20))
        ...
        self.sia_coin.setGeometry(QtCore.QRect(264, 440, 90, 16))
        ...
        self.xmr_coin.setGeometry(QtCore.QRect(443, 440, 90, 16))
        ...
        self.pasc_coin.setGeometry(QtCore.QRect(264, 590, 90, 16))
        ...
        self.monero_gpu = QtWidgets.QPushButton(ChooseCurrency)
        self.monero_gpu.setEnabled(True)
        self.monero_gpu.setGeometry(QtCore.QRect(83, 620, 90, 90))
        self.monero_gpu.setStyleSheet("background-color:rgb(105, 105, 105);")
        self.monero_gpu.setText("")
        self.monero_gpu.setIcon(icon5)
        self.monero_gpu.setIconSize(QtCore.QSize(90, 80))
        self.monero_gpu.setObjectName("monero_gpu")
        self.monero_gpu_cpu = QtWidgets.QPushButton(ChooseCurrency)
        self.monero_gpu_cpu.setEnabled(True)
        self.monero_gpu_cpu.setGeometry(QtCore.QRect(264, 620, 90, 90))
        self.monero_gpu_cpu.setStyleSheet("background-color:rgb(105, 105, 105);")
        self.monero_gpu_cpu.setText("")
        self.monero_gpu_cpu.setIcon(icon5)
        self.monero_gpu_cpu.setIconSize(QtCore.QSize(90, 80))
        self.monero_gpu_cpu.setObjectName("monero_gpu_cpu")
        self.label_8 = QtWidgets.QLabel(ChooseCurrency)
        self.label_8.setGeometry(QtCore.QRect(220, 720, 181, 20))
        self.label_8.setStyleSheet("color:rgb(0, 255, 0)")
        self.label_8.setObjectName("label_8")
        self.label_12 = QtWidgets.QLabel(ChooseCurrency)
        self.label_12.setGeometry(QtCore.QRect(90, 720, 91, 16))
    ...
    def retranslateUi(self, ChooseCurrency):
        ...
        self.label_8.setText(_translate("ChooseCurrency", "Monero CPU + Monero GPU"))
        self.label_12.setText(_translate("ChooseCurrency", "Monero GPU"))
